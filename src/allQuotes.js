const allQuotes = [
  ...
  {
    quote:
      "Your close friends always seem to know \nWhen there's something really wrong",
    song: "The Moment I Knew",
    album: "Red",
  },
  {
  ...
  {
    quote:
      "Do you remember when I pulled up and said 'get in the car' \nAnd then cancelled my plans just in case you called",
    song: "August",
    album: "Folklore",
  },
  {
  ...
  {
    quote:
      "I know where it all where wrong, your favorite song was playing from the far side of the gym \nI was nowhere to be found I hate the crowds \nPlus I saw you dance with him",
    song: "Betty",
    album: "Folklore",
  },
  {
  ...
  {
    quote:
      "So yeah, it's a fire, it's a goddamn blaze in the dark and you've started it \nSo yeah, it's a war, it's the goddamn fight of my life and you started it",
    song: "Ivy",
    album: "Evermore",
  },
  {
